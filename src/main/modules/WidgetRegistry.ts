...
import type { Widget, Action } from "../../renderer/types"

const WIDGETS_REGISTRY: Widget[] = [
  {
    id: "translator",
    label: "Translator",
    icon: "🌐",
...
// Get widget by ID
ipcMain.handle("get-widget", (event, widgetId: string) => {
...
export function registerAction(widgetId: string, action: Action) {
