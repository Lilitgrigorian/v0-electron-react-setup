...
export async function registerTranslatorIPC(store) {
    ...
    ipcMain.handle("execute-action", async (_event, { actionId }) => {
        try {
    ...
    ipcMain.handle("copy-translation", async (_event, text) => {
        try {
    ...
    ipcMain.handle("set-default-language", (_event, language) => {
